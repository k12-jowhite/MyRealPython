...
def print_text(surface, text, font, line=1, elev=None, align=None, color=Color("tomato")) :
    ...
    rect.center = Vector2(text_pos_x, text_pos_y + text_surface.get_height() * (line - 1))
